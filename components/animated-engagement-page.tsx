            ...
            <div className="relative z-10 text-center space-y-12">
              ...
              >
                ...
                >
                  ...
                  <span className="block">Lamis</span>
                </motion.h1>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">March 29, 2026</p>
                    </div>
                  </div>
                </motion.div>
      ...
      <section id="countdown" className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-b from-background to-accent/5">
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            <CountdownTimer targetDate={new Date("2026-03-29T18:00:00")} />
          </motion.div>
        </motion.div>
      </section>
                      ...
                      <div className="relative z-10">
                        ...
                        >
                          <div className="flex items-center gap-4 text-lg">
                            ...
                            <span className="text-xl font-medium text-foreground">March 29, 2026</span>
                          </div>
                          ...
                          <div className="flex items-center gap-4 text-lg">
                            ...
                            <span className="text-xl font-medium text-foreground">٧:00 PM</span>
                          </div>
                        </motion.div>

                        <p className="text-lg md:text-xl text-muted-foreground mt-6 text-center">
